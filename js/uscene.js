...
var uscene = (function () {
     ...
     */
    uscene.prototype.init = function (id) {
     ...
     */
    uscene.prototype.resize = function (svgWidth, svgHeight, zoom) {
     ...
     */
    uscene.prototype.clean = function () {
     ...
     */
    uscene.prototype.creatMarker = function (option) {
     ...
     */
    uscene.prototype.creatNode = function (option) {
     ...
     */
    uscene.prototype.creatLine = function (option) {
     ...
     */
    uscene.prototype.creatBrokenLine = function (option) {
     ...
     */
    uscene.prototype.spof = function () {
        var _this = this;
        this.draw.spof();
        SVG.on(window, 'resize', function () { _this.draw.spof(); });
    };
    uscene.prototype.get = function (id) {
        return SVG.get(id);
    };
    uscene.prototype.select = function (selectors) {
     ...
     */
    uscene.prototype.resetting = function (option) {
        var setting = option;
     ...
     */
    uscene.prototype.drawLine = function () {
        var _this = this;
        var interim;
        var offset;
        var sNode;
     ...
     */
    uscene.prototype.drawBrokenLine = function () {
        var _this = this;
        var interim;
        var offset;
        var sNode;
     ...
     */
    uscene.prototype.getJson = function () {
        var allJson = {
            setting: {},
            object: [],
            line: [],
     ...
     */
    uscene.prototype.getSVG = function () {
     ...
     */
    uscene.prototype.getImg = function () {
        var svgXml = $(this.draw.node).parent().html();
        var image = new Image();
     ...
     */
    uscene.prototype.drawJson = function (json) {
        var _this = this;
        this.clean();
 ...
 */
    uscene.prototype.randId = function (str) {
     ...
     * @param    {[type]}                 y2        [顶点二坐标]
     */
    uscene.prototype.lineDistancePoint = function (distance1, distance2, x1, y1, x2, y2) {
        var xs, xe, ye, ys;
        if (x1 == x2) {
            xs = x1;
            xe = x2;
     ...
     * @param    {[type]}                 k        [斜率]
     */
    uscene.prototype.linearrowheadPoint = function (distance, x1, y1, x2, y2, k) {
        var xa1, xa2, ya1, ya2;
        var xe, ye;
     ...
     * @param    {[type]}                 angle [角度]
     */
    uscene.prototype.rectcentertosidedistance = function (w, h, angle) {
     ...
     * @param    {[type]}                 y2 [顶点二坐标]
     */
    uscene.prototype.rectcentertosideangle = function (x1, y1, x2, y2) {
        var dx = x2 - x1;
        var dy = y2 - y1;
     ...
     */
    uscene.prototype.lineDistance = function (stype, etype, sNodetbox, eNodetbox) {
...
var node = (function () {
     ...
     */
    node.prototype.creatContainer = function () {
     ...
     */
    node.prototype.creatContent = function () {
     ...
     */
    node.prototype.creatText = function () {
     ...
     */
    node.prototype.creatgroup = function () {
     ...
     */
    node.prototype.changeContent = function (option) {
     ...
     * @param    {[type]}                 option [description]
     */
    node.prototype.changeContainer = function (option) {
        var group = typeof this.group == 'Object' ? this.group : this;
     ...
     * @param    {[type]}                 option [description]
     */
    node.prototype.addSign = function (option) {
        var group = typeof this.group == 'Object' ? this.group : this;
        var uscene = group.doc().origin;
     ...
     */
    node.prototype.removeSign = function (id) {
        var group = typeof this.group == 'Object' ? this.group : this;
     ...
     */
    node.prototype.dragmove = function () {
        var _this = this;
        this.group.on('dragstart.group', function () {
            _this.group.style('cursor', 'move');
            var nodeId = _this.group.attr("id");
            _this.line = $("polyline[id*='" + nodeId + "']");
            _this.group.on('dragmove.group', function (event) {
                var containerTbox = _this.group.container.tbox();
                var cx = containerTbox.cx;
                var cy = containerTbox.cy;
                _this.line.each(function () {
                    this.instance.lineChange(cx, cy, nodeId);
                });
            });
            _this.group.on('dragend.group', function (event) {
                _this.group.off('dragmove.group');
                _this.group.off('dragend.group');
                _this.group.style('cursor', null);
                var containerTbox = _this.group.container.tbox();
                var cx = containerTbox.cx;
                var cy = containerTbox.cy;
                var drawHeight = $(_this.uscene.draw.node).height();
                var drawWidth = $(_this.uscene.draw.node).width();
                if (containerTbox.y2 > drawHeight) {
                    _this.uscene.resize(drawWidth, containerTbox.y2 + 50);
                    _this.uscene.setting.svgHeight = containerTbox.y2 + 50;
                    _this.uscene.setting.svgWidth = drawWidth;
                }
                if (containerTbox.x2 > drawWidth) {
                    _this.uscene.resize(containerTbox.x2 + 50, drawHeight);
                    _this.uscene.setting.svgHeight = drawHeight;
                    _this.uscene.setting.svgWidth = containerTbox.x2 + 50;
                }
                _this.line.each(function () {
                    this.instance.lineChange(cx, cy, nodeId);
                });
...
var marker = (function () {
    ...
    marker.prototype.creatMarker = function () {
...
var line = (function () {
     ...
     */
    line.prototype.creatArrow = function () {
        var _this = this;
        this.arrowMarker = this.uscene.draw.marker(14, 10, function (add) {
            add.polyline([[0, 0], [0, 10], [8, 5]]).fill(_this.option.style.stroke);
        });
     ...
     * @param    {[type]}                 eNode [description]
     */
    line.prototype.creatArray = function (sNode, eNode) {
        sNode = SVG.get(sNode);
        eNode = SVG.get(eNode);
        sNodeTbox = sNode.container.tbox();
        eNodeTbox = eNode.container.tbox();
     ...
     */
    line.prototype.creatLine = function () {
     ...
     */
    line.prototype.animation = function (state) {
        state = typeof state === 'undefined' ? true : state;
     ...
     */
    line.prototype.creatText = function () {
     ...
     */
    line.prototype.lineChange = function (cx, cy, nodeId) {
 ...
 * 折线
 */
var brokenLine = (function (_super) {
    __extends(brokenLine, _super);
    function brokenLine(uscene, option) {
        this.uscene = uscene;
        this.sNode = option.sNode;
        this.eNode = option.eNode;
        this.option = option;
     ...
     */
    brokenLine.prototype.creatText = function () {
     ...
     */
    brokenLine.prototype.lineChange = function (cx, cy, nodeId) {
        var sNodeContainer = SVG.get(this.sNode).container;
        var eNodeContainer = SVG.get(this.eNode).container;
        var sNodetbox = sNodeContainer.tbox();
        var eNodetbox = eNodeContainer.tbox();
...
//# sourceMappingURL=uscene.js.map